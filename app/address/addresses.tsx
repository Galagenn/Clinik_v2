...
const branches: Branch[] = [
  {
    city: "Астана",
    address: "Казахстан, г. Астана, улица Мәскеу, дом 11А, 010000",
    phone: "+7 702 698 2336",
    email: "info@ica.example",
    hours: "Пн–Пт 08:00–17:00; Сб 08:00–13:00 (рентген/флюорография); Вс выходной",
    parking: "Бесплатная парковка у входа",
    transport: "Автобусы по ул. Мәскеу",
  },
];

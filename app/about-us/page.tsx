            ...
            <div className="mx-auto !max-w-[88rem] items-start gap-10 py-12 sm:py-20 md:grid md:grid-cols-2">
              <div>
                <h2 className="text-2xl font-semibold tracking-tight sm:text-3xl">Свяжитесь с нами</h2>
                           ...
                           <div><a href="tel:+77026982336" className="hover:text-primary transition-colors">+7 702 698 2336</a></div>
                           <div><span className="text-foreground/60">Адрес:</span> <a href="https://go.2gis.com/jUVuo" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors">Казахстан, г. Астана, улица Мәскеу, дом 11А, 010000</a></div>

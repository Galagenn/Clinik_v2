    ...
    <footer className="mt-16 border-t border-border/60 bg-white">
      <div className="container grid gap-10 pb-12 pt-12 text-sm text-foreground sm:grid-cols-2 lg:grid-cols-4">
        <div>
          ...
          <p className="text-foreground/70">Международный медицинский центр &quot;International Clinic of Asia&quot; – многопрофильный медицинский центр в г. Астана. Консультации специалистов, диагностические исследования, дневной стационар, медосмотры и оформление справок. Оснащена современным оборудованием.</p>
        </div>
        <div>
